...
urlpatterns = [
    ...
    path('editar_emprestimos/<int:id>/', views.editar_emprestimo, name='editar_emprestimo'),
    path('excluir_emprestimos/<int:id>/', views.excluir_emprestimo, name='excluir_emprestimo'),
]