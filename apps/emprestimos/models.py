...
class Emprestimo(models.Model):
    ...
    data_emprestimo = models.DateField(verbose_name='Data Empréstimo', default=date.today())
    ...
    status = models.CharField(max_length=10, choices=[('Emprestado','Emprestado'), ('Devolvido','Devolvido')], default='Emprestado')
